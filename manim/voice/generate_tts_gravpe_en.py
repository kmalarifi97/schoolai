"""Generate English TTS for the gravpe (gravitational potential energy) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_gravpe_en.json").read_text())
OUTPUT_DIR = HERE / "audio_gravpe_en"
