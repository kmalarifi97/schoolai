"""Generate English TTS for the momentumcons (Conservation of Momentum)
scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_momentumcons_en.json").read_text())
OUTPUT_DIR = HERE / "audio_momentumcons_en"
...
"Isolated." or "They cancel." are landing beats — give them air before and
after, not energy.
...
not an audience. The closing beat that hands the problem back to the student
should feel like trust, not a sign-off.
