"""Generate English TTS for the workenergy (Work–Energy Theorem) scene
(12 beats)."""
...
NARRATION = json.loads((HERE / "narration_workenergy_en.json").read_text())
OUTPUT_DIR = HERE / "audio_workenergy_en"
...
"None." or "Exactly." are landing beats — give them air before and after,
not energy.
...
not an audience. The wall beats should be sober, not dramatic — like saying
something true that's a little humbling.
