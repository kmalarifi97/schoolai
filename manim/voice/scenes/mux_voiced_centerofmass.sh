...
OUT_DIR="$PROJ_VOICE/voiced_centerofmass"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_centerofmass_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="CenterofmassS1B${i}"
  VIDEO="scenes/media/videos/centerofmass_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_centerofmass_en/s1_b${i}.mp3"
  OUT="voiced_centerofmass/voiced_centerofmass_b${i}.mp4"
