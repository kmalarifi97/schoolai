...
OUT_DIR="$PROJ_VOICE/voiced_momentumcons"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_momentumcons_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="MomentumconsS1B${i}"
  VIDEO="scenes/media/videos/momentumcons_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_momentumcons_en/s1_b${i}.mp3"
  OUT="voiced_momentumcons/voiced_momentumcons_b${i}.mp4"
