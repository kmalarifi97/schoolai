...
OUT_DIR="$PROJ_VOICE/voiced_skatepark"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_skatepark_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 25); do
  CLASS="SkateparkS1B${i}"
  VIDEO="scenes/media/videos/skatepark_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_skatepark_en/s1_b${i}.mp3"
  OUT="voiced_skatepark/voiced_skatepark_b${i}.mp4"
