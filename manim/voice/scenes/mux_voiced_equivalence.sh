...
OUT_DIR="$PROJ_VOICE/voiced_equivalence"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_equivalence_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="EquivalenceS1B${i}"
  VIDEO="scenes/media/videos/equivalence_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_equivalence_en/s1_b${i}.mp3"
  OUT="voiced_equivalence/voiced_equivalence_b${i}.mp4"
