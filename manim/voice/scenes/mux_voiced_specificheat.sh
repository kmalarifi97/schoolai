...
OUT_DIR="$PROJ_VOICE/voiced_specificheat"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_specificheat_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="SpecificheatS1B${i}"
  VIDEO="scenes/media/videos/specificheat_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_specificheat_en/s1_b${i}.mp3"
  OUT="voiced_specificheat/voiced_specificheat_b${i}.mp4"
