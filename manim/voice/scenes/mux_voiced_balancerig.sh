...
OUT_DIR="$PROJ_VOICE/voiced_balancerig"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_balancerig_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 24); do
  CLASS="BalancerigS1B${i}"
  VIDEO="scenes/media/videos/balancerig_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_balancerig_en/s1_b${i}.mp3"
  OUT="voiced_balancerig/voiced_balancerig_b${i}.mp4"
