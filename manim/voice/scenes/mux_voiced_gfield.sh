...
OUT_DIR="$PROJ_VOICE/voiced_gfield"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_gfield_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="GfieldS1B${i}"
  VIDEO="scenes/media/videos/gfield_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_gfield_en/s1_b${i}.mp3"
  OUT="voiced_gfield/voiced_gfield_b${i}.mp4"
