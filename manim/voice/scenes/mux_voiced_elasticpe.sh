...
OUT_DIR="$PROJ_VOICE/voiced_elasticpe"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_elasticpe_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="ElasticpeS1B${i}"
  VIDEO="scenes/media/videos/elasticpe_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_elasticpe_en/s1_b${i}.mp3"
  OUT="voiced_elasticpe/voiced_elasticpe_b${i}.mp4"
