...
OUT_DIR="$PROJ_VOICE/voiced_gravpe"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_gravpe_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="GravpeS1B${i}"
  VIDEO="scenes/media/videos/gravpe_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_gravpe_en/s1_b${i}.mp3"
  OUT="voiced_gravpe/voiced_gravpe_b${i}.mp4"
