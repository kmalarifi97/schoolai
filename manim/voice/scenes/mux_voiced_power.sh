...
OUT_DIR="$PROJ_VOICE/voiced_power"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_power_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="PowerS1B${i}"
  VIDEO="scenes/media/videos/power_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_power_en/s1_b${i}.mp3"
  OUT="voiced_power/voiced_power_b${i}.mp4"
