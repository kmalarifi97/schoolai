...
OUT_DIR="$PROJ_VOICE/voiced_collisionlab"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_collisionlab_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 25); do
  CLASS="CollisionlabS1B${i}"
  VIDEO="scenes/media/videos/collisionlab_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_collisionlab_en/s1_b${i}.mp3"
  OUT="voiced_collisionlab/voiced_collisionlab_b${i}.mp4"
