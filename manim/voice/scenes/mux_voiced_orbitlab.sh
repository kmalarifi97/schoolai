...
OUT_DIR="$PROJ_VOICE/voiced_orbitlab"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_orbitlab_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 24); do
  CLASS="OrbitlabS1B${i}"
  VIDEO="scenes/media/videos/orbitlab_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_orbitlab_en/s1_b${i}.mp3"
  OUT="voiced_orbitlab/voiced_orbitlab_b${i}.mp4"
