...
OUT_DIR="$PROJ_VOICE/voiced_efficiency"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_efficiency_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="EfficiencyS1B${i}"
  VIDEO="scenes/media/videos/efficiency_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_efficiency_en/s1_b${i}.mp3"
  OUT="voiced_efficiency/voiced_efficiency_b${i}.mp4"
