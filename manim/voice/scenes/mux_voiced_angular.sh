...
OUT_DIR="$PROJ_VOICE/voiced_angular"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_angular_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="AngularS1B${i}"
  VIDEO="scenes/media/videos/angular_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_angular_en/s1_b${i}.mp3"
  OUT="voiced_angular/voiced_angular_b${i}.mp4"
