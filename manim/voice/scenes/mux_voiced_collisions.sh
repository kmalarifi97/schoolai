...
OUT_DIR="$PROJ_VOICE/voiced_collisions"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_collisions_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="CollisionsS1B${i}"
  VIDEO="scenes/media/videos/collisions_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_collisions_en/s1_b${i}.mp3"
  OUT="voiced_collisions/voiced_collisions_b${i}.mp4"
