...
OUT_DIR="$PROJ_VOICE/voiced_torque"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_torque_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="TorqueS1B${i}"
  VIDEO="scenes/media/videos/torque_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_torque_en/s1_b${i}.mp3"
  OUT="voiced_torque/voiced_torque_b${i}.mp4"
