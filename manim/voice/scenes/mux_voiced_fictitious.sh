...
OUT_DIR="$PROJ_VOICE/voiced_fictitious"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_fictitious_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="FictitiousS1B${i}"
  VIDEO="scenes/media/videos/fictitious_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_fictitious_en/s1_b${i}.mp3"
  OUT="voiced_fictitious/voiced_fictitious_b${i}.mp4"
