...
OUT_DIR="$PROJ_VOICE/voiced_impulse"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_impulse_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="ImpulseS1B${i}"
  VIDEO="scenes/media/videos/impulse_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_impulse_en/s1_b${i}.mp3"
  OUT="voiced_impulse/voiced_impulse_b${i}.mp4"
