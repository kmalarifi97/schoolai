...
OUT_DIR="$PROJ_VOICE/voiced_workenergy"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_workenergy_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="WorkenergyS1B${i}"
  VIDEO="scenes/media/videos/workenergy_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_workenergy_en/s1_b${i}.mp3"
  OUT="voiced_workenergy/voiced_workenergy_b${i}.mp4"
