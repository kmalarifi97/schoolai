...
OUT_DIR="$PROJ_VOICE/voiced_rotke"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_rotke_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="RotkeS1B${i}"
  VIDEO="scenes/media/videos/rotke_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_rotke_en/s1_b${i}.mp3"
  OUT="voiced_rotke/voiced_rotke_b${i}.mp4"
