...
OUT_DIR="$PROJ_VOICE/voiced_heattransfer"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_heattransfer_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="HeattransferS1B${i}"
  VIDEO="scenes/media/videos/heattransfer_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_heattransfer_en/s1_b${i}.mp3"
  OUT="voiced_heattransfer/voiced_heattransfer_b${i}.mp4"
