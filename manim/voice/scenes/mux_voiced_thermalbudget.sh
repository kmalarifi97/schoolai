...
OUT_DIR="$PROJ_VOICE/voiced_thermalbudget"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_thermalbudget_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 24); do
  CLASS="ThermalbudgetS1B${i}"
  VIDEO="scenes/media/videos/thermalbudget_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_thermalbudget_en/s1_b${i}.mp3"
  OUT="voiced_thermalbudget/voiced_thermalbudget_b${i}.mp4"
