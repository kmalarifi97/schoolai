...
OUT_DIR="$PROJ_VOICE/voiced_machines"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_machines_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="MachinesS1B${i}"
  VIDEO="scenes/media/videos/machines_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_machines_en/s1_b${i}.mp3"
  OUT="voiced_machines/voiced_machines_b${i}.mp4"
