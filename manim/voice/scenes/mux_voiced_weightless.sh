...
OUT_DIR="$PROJ_VOICE/voiced_weightless"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_weightless_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="WeightlessS1B${i}"
  VIDEO="scenes/media/videos/weightless_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_weightless_en/s1_b${i}.mp3"
  OUT="voiced_weightless/voiced_weightless_b${i}.mp4"
