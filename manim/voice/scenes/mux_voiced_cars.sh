...
OUT_DIR="$PROJ_VOICE/voiced_cars"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_cars_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 28); do
  CLASS="CarsS1B${i}"
  VIDEO="scenes/media/videos/cars_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_cars_en/s1_b${i}.mp3"
  OUT="voiced_cars/voiced_cars_b${i}.mp4"
