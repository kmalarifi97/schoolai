...
OUT_DIR="$PROJ_VOICE/voiced_latentheat"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_latentheat_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="LatentheatS1B${i}"
  VIDEO="scenes/media/videos/latentheat_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_latentheat_en/s1_b${i}.mp3"
  OUT="voiced_latentheat/voiced_latentheat_b${i}.mp4"
