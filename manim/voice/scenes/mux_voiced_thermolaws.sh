...
OUT_DIR="$PROJ_VOICE/voiced_thermolaws"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_thermolaws_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 12); do
  CLASS="ThermolawsS1B${i}"
  VIDEO="scenes/media/videos/thermolaws_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_thermolaws_en/s1_b${i}.mp3"
  OUT="voiced_thermolaws/voiced_thermolaws_b${i}.mp4"
