...
OUT_DIR="$PROJ_VOICE/voiced_springdrop"
mkdir -p "$OUT_DIR"
TAIL=0.30
...
DUR_LIST="$PROJ_VOICE/durations_springdrop_en.txt"
: > "$DUR_LIST"

for i in $(seq 1 24); do
  CLASS="SpringdropS1B${i}"
  VIDEO="scenes/media/videos/springdrop_b${i}/720p30/${CLASS}.mp4"
  AUDIO="audio_springdrop_en/s1_b${i}.mp3"
  OUT="voiced_springdrop/voiced_springdrop_b${i}.mp4"
