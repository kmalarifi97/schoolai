"""Generate English TTS for the gfield (gravitational field) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_gfield_en.json").read_text())
OUTPUT_DIR = HERE / "audio_gfield_en"
