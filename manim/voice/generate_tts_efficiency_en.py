"""Generate English TTS for the efficiency (ideal vs real machines) scene
(12 beats)."""
...
NARRATION = json.loads((HERE / "narration_efficiency_en.json").read_text())
OUTPUT_DIR = HERE / "audio_efficiency_en"
