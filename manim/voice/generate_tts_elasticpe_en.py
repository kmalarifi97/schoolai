"""Generate English TTS for the elasticpe (gravitational field) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_elasticpe_en.json").read_text())
OUTPUT_DIR = HERE / "audio_elasticpe_en"
