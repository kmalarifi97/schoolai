"""Generate English TTS for the thermolaws (Laws of Thermodynamics & Entropy) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_thermolaws_en.json").read_text())
OUTPUT_DIR = HERE / "audio_thermolaws_en"
...
"Ever." or "Wrong." are landing beats — give them air before and after,
not energy.
...
not an audience. The closing beat ("that's yours.") hands the thinking back
to the student — sober and quiet, not a flourish.
