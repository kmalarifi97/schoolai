"""Generate English TTS for the rotke (rotational kinetic energy) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_rotke_en.json").read_text())
OUTPUT_DIR = HERE / "audio_rotke_en"
...
"Wrong." or "Zero." are landing beats — give them air before and after,
not energy.
