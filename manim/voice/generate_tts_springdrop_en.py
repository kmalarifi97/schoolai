"""Generate English TTS for the springdrop project-story (24 beats)."""
...
NARRATION = json.loads((HERE / "narration_springdrop_en.json").read_text())
OUTPUT_DIR = HERE / "audio_springdrop_en"
...
watching Yousef, not being taught at. Slow is correct. You are thinking
...
"Once." are landing beats — give them air before and after, not energy.

Tone: curiosity, not excitement. The launcher that "still overshoots"
should be said plainly, with quiet sympathy, not drama. The closing
callbacks (b21-b24) are a soft remembering — almost to yourself — not a
recap. The final lines settle into stillness; let the silence at the end
hold.
