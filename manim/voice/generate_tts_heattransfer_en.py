"""Generate English TTS for the heattransfer (heat transfer) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_heattransfer_en.json").read_text())
OUTPUT_DIR = HERE / "audio_heattransfer_en"
...
"Touch." or "Flow." are landing beats — give them air before and after,
not energy.
