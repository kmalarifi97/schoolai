"""Generate English TTS for the balancerig project-story (24 beats)."""
...
NARRATION = json.loads((HERE / "narration_balancerig_en.json").read_text())
OUTPUT_DIR = HERE / "audio_balancerig_en"
...
watching Lina, not being taught at. Slow is correct. You are thinking
...
a slight pitch lift, then continue. Short lines like "Exactly." or "Once."
are landing beats — give them air before and after, not energy.

Tone: curiosity, not excitement. The mobile that "keeps tilting" should
be said plainly, with quiet sympathy, not drama. The closing callbacks
(b21-b24) are a soft remembering — almost to yourself — not a recap.
