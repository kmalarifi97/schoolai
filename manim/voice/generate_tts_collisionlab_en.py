"""Generate English TTS for the collisionlab project-story (25 beats)."""
...
NARRATION = json.loads(
    (HERE / "narration_collisionlab_en.json").read_text())
OUTPUT_DIR = HERE / "audio_collisionlab_en"
...
watching Noura, not being taught at. Slow is correct. You are thinking
...
a slight pitch lift, then continue. Short lines like "Always." or
"Wrong." are landing beats — give them air before and after, not energy.

Tone: curiosity, not excitement. The dent that "lies on its own" should
be said plainly, with quiet sympathy, not drama. The closing callbacks
(b22-b25) are a soft remembering — almost to yourself — not a recap.
