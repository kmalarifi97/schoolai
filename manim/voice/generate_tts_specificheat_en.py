"""Generate English TTS for the specificheat (specific heat) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_specificheat_en.json").read_text())
OUTPUT_DIR = HERE / "audio_specificheat_en"
