"""Generate English TTS for the centerofmass (Center of Mass & Stability)
scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_centerofmass_en.json").read_text())
OUTPUT_DIR = HERE / "audio_centerofmass_en"
