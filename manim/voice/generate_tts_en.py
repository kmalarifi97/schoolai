"""
Generate English TTS for all beats with the full voice direction.
Usage:
    OPENAI_API_KEY=sk-... python3 generate_tts_en.py b1
    OPENAI_API_KEY=sk-... python3 generate_tts_en.py all
"""
...
NARRATION = json.loads((HERE / "narration_en.json").read_text())
OUTPUT_DIR = HERE / "audio_en"
