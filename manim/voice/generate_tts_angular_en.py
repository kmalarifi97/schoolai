"""Generate English TTS for the angular (angular motion) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_angular_en.json").read_text())
OUTPUT_DIR = HERE / "audio_angular_en"
