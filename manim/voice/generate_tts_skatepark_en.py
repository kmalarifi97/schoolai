"""Generate English TTS for the skatepark project-story (25 beats)."""
...
NARRATION = json.loads((HERE / "narration_skatepark_en.json").read_text())
OUTPUT_DIR = HERE / "audio_skatepark_en"
...
watching Faris, not being taught at. Slow is correct. You are thinking
...
a slight pitch lift, then continue. Short lines like "Short again." or
"Wrong." are landing beats — give them air before and after, not energy.

Tone: curiosity, not excitement. The ramp "keeps lying to him" should be
said plainly, with quiet sympathy, not drama. The closing callbacks
(b24-b25) are a soft remembering — almost to yourself — not a recap.
