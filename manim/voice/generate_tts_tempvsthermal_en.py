"""Generate English TTS for the tempvsthermal (gravitational field) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_tempvsthermal_en.json").read_text())
OUTPUT_DIR = HERE / "audio_tempvsthermal_en"
...
not an audience. The b25 crash beat in particular should be sober, not
