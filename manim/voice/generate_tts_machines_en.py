"""Generate English TTS for the machines (simple machines) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_machines_en.json").read_text())
OUTPUT_DIR = HERE / "audio_machines_en"
...
slight pitch lift, then continue. Single-word or very short lines are landing
beats — give them air before and after, not energy.
...
not an audience. "It feels like cheating." should sound like a quiet
confession, not a punchline.
