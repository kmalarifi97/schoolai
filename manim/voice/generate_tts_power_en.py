"""Generate English TTS for the power (rate of doing work) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_power_en.json").read_text())
OUTPUT_DIR = HERE / "audio_power_en"
...
not an audience. Lines about the sprint nearly killing you should be sober and
matter-of-fact, not dramatic — like saying something true that's unpleasant.
