"""Generate English TTS for the weightless (gravitational field) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_weightless_en.json").read_text())
OUTPUT_DIR = HERE / "audio_weightless_en"
