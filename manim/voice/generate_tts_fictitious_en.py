"""Generate English TTS for the fictitious-forces (centrifugal &
Coriolis) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_fictitious_en.json").read_text())
OUTPUT_DIR = HERE / "audio_fictitious_en"
