"""Generate English TTS for the torque (Torque & the Lever Arm) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_torque_en.json").read_text())
OUTPUT_DIR = HERE / "audio_torque_en"
...
"Nothing." or "Torque." are landing beats — give them air before and after,
not energy.
...
not an audience. The closing hand-back ("that's yours") should be sober and
generous, not a flourish.
