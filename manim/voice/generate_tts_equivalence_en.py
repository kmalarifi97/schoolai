"""Generate English TTS for the equivalence (inertial vs gravitational
mass / equivalence principle) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_equivalence_en.json").read_text())
OUTPUT_DIR = HERE / "audio_equivalence_en"
...
"And yet." or "A clue." are landing beats — give them air before and after,
not energy.
...
not an audience. The closing question should be sincere, an invitation, not
rhetorical flourish.
