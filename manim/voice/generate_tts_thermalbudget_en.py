"""Generate English TTS for the thermalbudget project-story (24 beats)."""
...
NARRATION = json.loads(
    (HERE / "narration_thermalbudget_en.json").read_text())
OUTPUT_DIR = HERE / "audio_thermalbudget_en"
...
watching Maha, not being taught at. Slow is correct. You are thinking
...
Tone: curiosity, not excitement. The thermometer that "stalls dead at
zero" should be said plainly, with quiet sympathy, not drama. The closing
