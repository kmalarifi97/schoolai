"""Generate English TTS for the collisions (elastic & inelastic) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_collisions_en.json").read_text())
OUTPUT_DIR = HERE / "audio_collisions_en"
...
"Dead." or "Zero." are landing beats — give them air before and after,
not energy.
...
not an audience. The clay "stop. Stuck together. Dead." beat in particular
should be sober, not dramatic — like saying something true that's unpleasant.
