"""Generate English TTS for the paperclip scene (30 beats)."""
...
NARRATION = json.loads((HERE / "narration_paperclip_en.json").read_text())
OUTPUT_DIR = HERE / "audio_paperclip_en"
...
"Matter is frozen energy." or "Less than one gram." are landing beats —
give them air before and after, not energy.
...
not an audience. The mushroom-cloud beats (b4, b26) should be sober, not
dramatic — true things spoken quietly.

Avoid: announcer cadence, falling-tone conclusiveness ("…and that's why…"),
performative warmth, over-articulated consonants, sweeping emphasis across
whole sentences.
""".strip()
