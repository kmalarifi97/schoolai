"""Generate English TTS for the latentheat (latent heat) scene (12 beats)."""
...
NARRATION = json.loads((HERE / "narration_latentheat_en.json").read_text())
OUTPUT_DIR = HERE / "audio_latentheat_en"
